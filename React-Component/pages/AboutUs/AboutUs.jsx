...
const AboutUs = () => {
    ...
    useEffect(() => {
        // Simulating cookie deletion logic
        ...
        <>
            ...
            <div className="container">
                <div className="row mb-3 pt-3 mb-sm-0 align-items-center">
                    ...
                    <div className="col-12 col-lg-6 order-lg-2 text-center first-pic">
                        <img src="/assets/images/aboutUs/about-us.png" alt="About Us" />
                    </div>
                </div>
                <img className="divider" src="/assets/images/homePage/divider.png" alt="Divider" />
            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-12 order-lg-2 current-chart">
                            <div className="d-flex align-items-center m-4 cs-right">
                                <img src="/assets/images/aboutUs/40.png" className="border-r" alt="State Qualifiers" />
                                <div className="ml-2">
                            ...
                            <div className="d-flex align-items-center m-4 cs-right">
                                <img src="/assets/images/aboutUs/09.png" className="border-y" alt="State Champions" />
                                <div className="ml-2">
                            ...
                            <div className="d-flex align-items-center m-4 cs-right">
                                <img src="/assets/images/aboutUs/02.png" className="border-o" alt="National Qualifiers" />
                                <div className="ml-2">
            ...
            <div className="container">
                ...
                <div className="picture2 text-center">
                    <img className="pic2" src="/assets/images/aboutUs/student.png" alt="Nicolle and Anthony" />
                </div>
